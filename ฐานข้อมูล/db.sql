...
INSERT INTO `options` VALUES (5, 'storageUrl', 'http://storage.pet.local/');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', 'chanpan.nuttaphon1993@gmail.com', '$2y$12$obnECeQ6R8r.lamu.Kdmo.S2OTh1Dh9TvsvfSpGQfpBChgFs3Tz6K', 'KSwmb0yFT6Jf14f82pSAnAedCN44uzAQ', 1535696234, NULL, NULL, '::1', 1535696234, 1535696234, 0, 1563776050);
