...
/* @var $searchModel backend\modules\core\models\CoreOptionSearch */
...
<div class="box box-primary">
    <div class="box-header">
         ...
         <div class="pull-right">
             <?= Html::button(SDHtml::getBtnAdd(), ['data-url'=>Url::to(['core-options/create']), 'class' => 'btn btn-success btn-sm', 'id'=>'modal-addbtn-core-options']). ' ' .
...
<script>
// JS script
$('#modal-addbtn-core-options').on('click', function() {
    modalCoreOption($(this).attr('data-url'));
});

$('#modal-delbtn-core-options').on('click', function() {
