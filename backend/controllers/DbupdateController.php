...
use Yii;
use backend\models\Dbupdate;
use backend\models\search\Dbupdate as DbupdateSearch;
...
/**
 * DbupdateController implements the CRUD actions for Dbupdate model.
 */
...
/*	    'access' => [
    ...
    /**
     * Lists all Dbupdate models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new DbupdateSearch();
    ...
    /**
     * Displays a single Dbupdate model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing Dbupdate model.
    ...
    /**
     * Deletes an existing Dbupdate model.
    ...
    /**
     * Finds the Dbupdate model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Dbupdate the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Dbupdate::findOne($id)) !== null) {
            return $model;
        } else {
